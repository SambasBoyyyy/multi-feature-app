...
class ApiProvider{
  Dio dio = Dio();
  final String _url = "http://sherpur.rbfgroupbd.com/get_notification";
  ...
  Future<ListModel> fetchList(int page) async {
    try{
      dio.options.headers['Authorization'] = 'Bearer $token';
      Response response = (await dio.get(_url + "?page=$page&pageSize=18") );
       print(response.data);
